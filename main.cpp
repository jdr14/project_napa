...
// Followed Readme at https://github.com/WiringPi/WiringPi to setup performant GPIO access library
#include <wiringPi.h>
...
#define BR_PWM1_1_PIN (1) // Pin 33 (Needs Alt func 0)
...
int main(void)
{
    ...
    digitalWrite(BR_MOTOR_PIN_A, HIGH);
